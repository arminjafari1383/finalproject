# Generated by Django 5.2.9 on 2026-08-13 06:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scope', models.CharField(choices=[('DOWNLINE_ONLY', 'Downline only'), ('ALL_WITHDRAWABLE', 'All withdrawable')], default='ALL_WITHDRAWABLE', max_length=32)),
                ('asset', models.CharField(choices=[('TON', 'TON'), ('ECG', 'ECG')], default='TON', max_length=8)),
                ('amount', models.DecimalField(decimal_places=6, max_digits=24)),
                ...
                ('balance_breakdown', models.JSONField(blank=True, default=dict)),
