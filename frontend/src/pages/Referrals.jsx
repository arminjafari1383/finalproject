...
export default function Referrals() {
  ...
  useEffect(() => {
    ...
    if (tg) {
      ...
      if (tg.initDataUnsafe?.user) {
        ...
        console.log(
          "⚠️ [DEBUG] No user data found in initDataUnsafe"
        );
      ...
      console.log(
        "⚠️ [DEBUG] Telegram WebApp NOT found - browser mode"
      );
  ...
  // ==========================================
  // Capture Inviter Code
  // ==========================================

  useEffect(() => {

    console.log(
      "🔍 [DEBUG] Capturing inviter code..."
    );
  ...
  // ==========================================
  // Register User + Fetch Referral Count
  // ==========================================
  ...
  useEffect(() => {
    ...
    if (hasFetched.current) {
      ...
      console.log(
        "⛔️ [DEBUG] Data already fetched, skipping."
      );
    ...
    async function fetchData() {
      ...
      try {
        ...
        if (
          ...
          console.log(
            "📂 [DEBUG] Using Telegram ID from storage:",
            finalTelegramId
          );
          ...
          finalTelegramId =
            getBrowserTelegramId;

          finalTelegramUsername =
            `browser_${address.slice(0, 8)}`;

          console.log(
            "🌐 [DEBUG] Using browser Telegram ID:",
            finalTelegramId
          );
        }
  ...
  useEffect(() => {
    ...
    async function fetchLevels() {
      ...
      try {
        ...
        console.log(
          "🔄 [DEBUG] Fetching referral levels..."
        );
        ...
        setTotalReferrals(
          response.data.total_referrals ||
          0
        );


        console.log(
          "✅ [DEBUG] Levels fetched:",
          response.data
        );
        ...
        <>
          ...
          <div className="referral-link-section">
            ...
            <div className="payment-boxes">
              ...
              <div className="payment-box usdt-payment-box">
                ...
                <div className="payment-box-header">
                  ...
                  <div>
                    ...
                    <h3 className="payment-box-title">
                      USDT Rewards
                    </h3>

                    <span className="payment-box-subtitle">
                      Referral rewards
                    </span>
                ...
                <div className="payment-box-content">
                  ...
                  <div className="ton-payment-method">

                    <span className="ton-payment-label">
                      Payment Network
                    </span>

                    <span className="ton-payment-value">
                      💎 TON
                    </span>
                  ...
                  <button
                    type="button"
                    className="payment-withdraw-btn usdt-withdraw-btn"
                    disabled={true}
                  >
                    💎 Withdraw USDT via TON
                  </button>


                  <div className="payment-note">
                    USDT rewards will be paid through the TON network.
                  </div>
              ...
              <div className="payment-box ecg-payment-box">
                ...
                <div className="payment-box-content">
                  ...
                  <button
                    type="button"
                    className="payment-withdraw-btn ecg-withdraw-btn"
                    disabled={true}
                  >
                    💎 Withdraw ECG via TON
                  </button>


                  <div className="payment-note">
                    ECG rewards will be paid through the TON network.
                  </div>
            ...
            <div className="info-note">
              ...
              💡 This link is a <b>website</b> link.
              Your friend can open it and then press{" "}
              <b>OPEN APP</b> in Telegram.
              ...
              testData && (
                ...
                <div className="test-table-section">
                  ...
                  <div className="test-note">
                    ...
                    ⚡ This is test data showing
                    how the referral tree will look
                    with sample users
